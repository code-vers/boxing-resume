 ...
 * @description The header section of the Terms of Service page, featuring the title "Terms of Service" 
 * and a brief description. Designed with a dark theme to match the Figma specifications.
 * @returns {JSX.Element} The rendered TermsBanner component.
 */
