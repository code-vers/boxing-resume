 ...
 */
export function RankingToolbar({ search, onSearchChange }: RankingToolbarProps) {
  return (
    <div className="flex justify-end items-center gap-3">
      ...
      <div className="relative w-72">
        ...
        <input
          ...
          className="block w-full pl-9 pr-3 py-2 border border-slate-200 rounded-md leading-5 bg-slate-50 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-1 focus:ring-primary focus:border-primary sm:text-sm transition-colors"
