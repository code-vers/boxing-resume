...
import { AddRankingDrawer } from "./AddRankingDrawer";
    ...
    <>
      <div className='flex justify-end items-center gap-3'>
        ...
        <button
          ...
          className='inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-btn-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors'>
