        ...
        <Table>
          <TableHeader className='bg-white'>
            <TableRow className='hover:bg-transparent'>
              <TableHead className='px-6 py-4 text-left text-[11px] font-bold tracking-wider text-[#656464] uppercase'>
                Fighter
              </TableHead>
              <TableHead className='px-6 py-4 text-left text-[11px] font-bold tracking-wider text-[#656464] uppercase'>
                Division
            ...
            {fighters.length > 0 ? (
              fighters.map((fighter) => (
                <TableRow
                  ...
                  <TableCell className='px-6 py-4 whitespace-nowrap'>
                    <div className='flex items-center'>
                      ...
                      <div className='ml-4'>
                        ...
                        <div className='text-xs text-[#656464] italic'>
                          {fighter.nickname || "No Alias"}
                        </div>
                        <div className='text-xs text-slate-400 flex items-center gap-1 mt-0.5'>
                          <span>
                            {fighter.nationality === "Mexico" ? "🇲🇽" : "🇺🇸"}
                          </span>{" "}
                  ...
                  <TableCell className='px-6 py-4 whitespace-nowrap text-sm text-[#656464] font-normal'>
                    {fighter.division}
                  </TableCell>
                  ...
                  <TableCell className='px-6 py-4 whitespace-nowrap text-sm font-normal text-foreground font-oswald'>
                    {fighter.ko_rate}%
                  </TableCell>
                  <TableCell className='px-6 py-4 whitespace-nowrap'>
                    <Badge
                      ...
                      {fighter.status.charAt(0).toUpperCase() +
                        fighter.status.slice(1)}
                    </Badge>
                  </TableCell>
                  <TableCell className='px-6 py-4 whitespace-nowrap text-sm text-text-placeholder font-normal'>
                    2 days ago
                  </TableCell>
                  <TableCell className='px-6 py-4 whitespace-nowrap text-[12px] font-medium'>
